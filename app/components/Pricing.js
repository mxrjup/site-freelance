  ...
  return (
    ...
    >
      ...
      <div className="pt-12 sm:pt-16">
        ...
        <Reveal delay={80}>
          <p className="mt-4 max-w-[620px] text-lg leading-relaxed text-forest/75">{t.paragraph}</p>
        </Reveal>
        ...
        <div className="mt-9 grid items-start gap-6 sm:mt-12 sm:grid-cols-2 sm:gap-8">
          ...
          >
            <h3 className="text-2xl leading-tight text-forest">{planA.title}</h3>
            <p className="mt-3 text-[16.5px] leading-relaxed text-forest/75">{planA.body}</p>
            <div className="mt-6 flex flex-col gap-1">
              <p className="font-display text-[27px] leading-tight text-clay sm:text-[33px]">
                {planA.price}
              </p>
              <p className="text-sm font-medium text-forest/60">{planA.priceNote}</p>
            </div>
          ...
          >
            ...
            <h3 className="mt-4 text-2xl leading-tight text-forest">{planB.title}</h3>
            <p className="mt-3 text-[16.5px] leading-relaxed text-forest/[0.78]">{planB.body}</p>
            <div className="mt-6 flex flex-col gap-1">
              <p className="font-display text-[27px] leading-tight text-clay sm:text-[33px]">
                {planB.price}
              </p>
              <p className="text-sm font-medium text-forest/[0.66]">{planB.priceNote}</p>
            </div>
            <ul className="mt-6 flex flex-col gap-3.5">
