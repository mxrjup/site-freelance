...
export default function NotFoundPage({ lang }) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-cream px-6 text-center dark:bg-night">
      <p className="text-sm font-medium text-forest/85 dark:text-cream/60">404</p>
      <h1
        id="not-found-h1"
        suppressHydrationWarning
        className="mt-2 text-3xl text-forest sm:text-4xl dark:text-cream"
      >
        {t.h1}
      </h1>
      <p
        ...
        suppressHydrationWarning
        className="mt-4 text-sm leading-6 text-forest/85 dark:text-cream/70"
      >
        {t.description}
      </p>
      <a
